...
namespace PhenoPad.Styles
{
    class MyColors
    {
        ...
        //public static SolidColorBrush Button_Background = new SolidColorBrush(Color.FromArgb(255, 93, 179, 254));
        //public static Color Button_Background_Color = Color.FromArgb(255, 93, 179, 254);
        //public static Color Button_Background_Color_TRANS = Color.FromArgb(120, 93, 179, 254);
